...
// (Task 10.2 wires --status / --type / --tier / --columns). The
// minimum threshold of 2 gives short inputs of length 0 or 1 a grace
// window — half of 0 is 0 but a single-byte typo is a real mistake
// that dashboards want to catch.

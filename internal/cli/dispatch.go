...
var descriptors = []commandDescriptor{
	...
	{Name: "complete", Handler: command.Complete, Elevated: false, RequiresWorkspace: true, SuppressTelemetry: false},
	{Name: "fail", Handler: command.Fail, Elevated: false, RequiresWorkspace: true, SuppressTelemetry: false},
	...
	{Name: "move", Handler: command.Move, Elevated: true, RequiresWorkspace: true, SuppressTelemetry: false},
	{Name: "link", Handler: command.Link, Elevated: true, RequiresWorkspace: true, SuppressTelemetry: false},
	{Name: "unlink", Handler: command.Unlink, Elevated: true, RequiresWorkspace: true, SuppressTelemetry: false},
	...
	{Name: "backup", Handler: command.Backup, Elevated: true, RequiresWorkspace: true, SuppressTelemetry: false},
}
